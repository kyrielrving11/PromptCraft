...
6. 使用“示例输出格式”表达结构要求。零样本思维链可以给格式骨架，但不要提供推理过程。
...
8. 在最后的提示词结尾加上一句话，Let’s work this out in a step by step way to be sure we have the right answer.
...
7. 在提示词的最后，加上 Let’s work this out in a step by step way to be sure we have the right answer.
8. 输出完整 Prompt。
